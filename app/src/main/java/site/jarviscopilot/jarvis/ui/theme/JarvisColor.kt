...
val JarvisLightBlueContainer = Color(0xFFBBDEFB) // Primary container color
val JarvisLightOnBlueContainer = Color(0xFF062E48) // On primary container color
val JarvisLightTeal = Color(0xFF26C6DA)
val JarvisLightTealContainer = Color(0xFFB2EBF2) // Secondary container color
val JarvisLightOnTealContainer = Color(0xFF003438) // On secondary container color
val JarvisLightAccent = Color(0xFF00BFA5)
val JarvisLightAccentContainer = Color(0xFFB2DFDB) // Tertiary container color
val JarvisLightOnAccentContainer = Color(0xFF003D36) // On tertiary container
val JarvisLightBackground = Color(0xFFF5F5F5)
val JarvisLightSurface = Color(0xFFFFFFFF)
...
val JarvisLightReferenceBackground = Color(0xFFDCD3E9) // Light purple background (made darker)
val JarvisLightWarning = Color(0xFFF57C00) // Orange for warning
val JarvisLightWarningBackground = Color(0xFFFFE0B2) // Light orange background
...
val JarvisBlueContainer = Color(0xFF82B1FF) // Primary container color
val JarvisOnBlueContainer = Color(0xFF001B3D) // On primary container color
val JarvisTeal = Color(0xFF00BCD4)
val JarvisTealContainer = Color(0xFF84FFFF) // Secondary container color
val JarvisOnTealContainer = Color(0xFF002021) // On secondary container color
val JarvisAccent = Color(0xFF64FFDA)
val JarvisAccentContainer = Color(0xFF005457) // Tertiary container color
val JarvisOnAccentContainer = Color(0xFFA7F3D0) // On tertiary container
val JarvisDarkBackground = Color(0xFF121212)
val JarvisDarkSurface = Color(0xFF1E1E1E)
...
val JarvisDarkWarning = Color(0xFFFFB74D) // Lighter orange for dark theme
val JarvisDarkWarningBackground = Color(0xFF773C00) // Dark orange background
